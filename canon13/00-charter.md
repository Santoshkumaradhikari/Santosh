...
- **B3. PARTIALLY UNBLOCKED (2026-08-29):** NRB's site is fetch-reachable. Captured today: Table 1 macro series (private-credit growth FY2022/23-25/26 = 4.6/6.1/8.1/6.6%; M2, T-bills, remittances) + English narrative banking figures (deposits +13.9%, private credit +6.5%, lending 6.55%) — in `corpus/evidence/nrb-macro-tables-2026-08-29.md`, sources SRC-0014…0017. **TEST-0001 pre-registered** in `ledger/tests.tsv` (method + PASS/FAIL/INCONCLUSIVE criteria fixed before seeing results). Remaining: (a) banking ROE section of the narrative (chunks 2-4) for the 7.73% / "13%→under 8%" claims; (b) NEPSE index history (NRB Tables 63/66 or neepse.com.np) for CON-0007 and the 2021 correction case; (c) monthly credit series (Table 70 / annex); (d) parse of Unified Directive 2083/84 (SRC-0016) to verify the CAR/CD/lending-limit claims (CLM-0023 + ch-65).
